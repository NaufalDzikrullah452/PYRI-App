...
import { compileFigmaReactElement } from './components/Code'
  ...
  const pluginEvents = useRef({
    ...
    'upd-frame': async (e: {
      ...
      if (e.html && e.page && e.frame) {
        ...
        payload.html = await compileFigmaReactElement(payload.html)
    ...
    action(() => {
      ...
      loadExt(`dev/buffer.js`).then((buffer) => {
        ...
        ;(import('@babel/generator') as any).then((e) => {
          window.babel.generate = e.default.default
        })
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-row flex-1">
        ...
        {meta.search && (
          <div
            className="search flex flex-col border-l border-gray-300"
            css={css`
              background: #fafafa;
              width: 35%;
              min-width: 150px;
