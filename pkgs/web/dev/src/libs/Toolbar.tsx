...
export const Toolbar = ({ back, id, title, actions, unsaved, saving }) => {
  return (
    <div>
      <Observer>
        {() => {
          return (
            ...
            >
              <div
                className="flex flex-row items-center text-xs font-medium cursor-pointer"
                onClick={back ? back : undefined}
              >
                {back && (
                  <Icon
